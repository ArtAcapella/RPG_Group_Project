...
public class Character {
	...
	public Character() {
		...
		System.out.println(
				"You wake up in the soft fluff of your bed. You're senses are greeted by the sour, acidic smell of the west coast mist that pours through the crack in the window across the room. Your Nova-brand immuno blockers lie on the bedside table");
		...
		while (windowClosed == false) {
			...
			if (moveChoice == 2) {
				System.out.println(
						"Its not worth getting out of bed right now... you fall back asleep. \n .\n .\n .\n .\n .\n .\n .\n .\n .\n .\nYou wake up again, the window is still open.");
			}
		...
		while (eating == false) {
			...
			if (moveChoice == 1 && heatingOn == false) {
				System.out.println(
						"You pull the roll of synapstring from your arm and plug it into your home's centeral control system. You read your current account balance after last nights rent as "
								+ account
								+ ". Turning on the heating for the morining will cost 2 Coyn.\n Do you want to turn on the heating? y/n");
				yesNo = sc.next().charAt(0);
				if (yesNo == 'y') {
					System.out.println(
							"You Jack Out, then run your hand over the flow of hot air coming from the ceiling vent.");
					heatingOn = true;
					account = account - 2;
				} else if (yesNo == 'n') {
					System.out.println(
							"You Jack Out, not worth spending that when Nova just hiked their immune blockers price.");
				}
			} else if (moveChoice == 2) {
				System.out.println(
						"You walk over to your bed and fall back asleep. \n .\n .\n .\n .\n .\n .\n .\n .\n .\n .\n");
			} else if (moveChoice == 3) {
				System.out.println(
						"You head over to vending machine across the room, ten steps from where you were sleeping. The neon advertisements entice you to purchase a cinamon onigiri egg, though you feel its likely safer to simply purchase your usual.");
				// open shop menu here?
				eating = true;
			}
		}
		...
		System.out.println(
				"You grab your food and sit down to eat. Your deck has finished rebooting and is now fully turned on, allowing you to access your digital systems through your AR eye implants. [type OPEN DECK]");
		String deckOppening = sc.nextLine();

		if (deckOppening.equalsIgnoreCase("open deck")) {
			System.out.println(
					"You see before you your Common Architecture of choice, DEiNet, and the gateway buttons to your favorite sites and programs.");
			deckMenu = true;
			while (deckMenu == true) {
				System.out.println(
						" 1: Run Diagnostic \n 2: Open News \n 3. Open Messages \n 4. Open CyberDeck \n 5. Exit");
