...
public class Character {
	...
	Character(String name, int moves, int buff, int quick, int tech, int hacking, int booksmarts, int streetsmarts,
			int dealing, int cool, int hpMAX, String[][] leveledAttackList, int baseAC) {
		this.moves = moves;
		this.buff = buff;
		this.quick = quick;
		this.tech = tech;
