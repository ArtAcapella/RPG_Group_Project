...
class main 
{
  ...
  Hacking h1 = new Hacking();
  	...
  	int aCool = 0;
  		...
  		System.out.println("What is your background? [Fallen Highriser (Recomended), Highriser, Corpo IT, Street Kid, Gang Runner, BlackMarket Student, Tourist]");
		...
		backgroundSelect = sc.nextLine();
  		...
  		//Character Ace = new	Character(ace, aQuick/4, aBuff, aQuick, aTech, aHacking, aBookS, aStreetS, aDealing, aCool, int hpMAX, String[][] leveledAttackList, int baseAC) {
  	    ...
  	    //For NPCs. Depending on their condition they will use different moves (1 = low danger, 3 = high danger)
  	    String[][] leveledAttackList = new String[3][2];
  	    
  	/*    
  	    String[][] rhyzLAL = new String[3][2];
  	    rhyzLAL[1][1] = "Punch";
  	    rhyzLAL[1][2] = "";
  	    rhyzLAL[2][1] = "Bladed Nails";
  	    rhyzLAL[2][2] = "";
  	    rhyzLAL[3][1] = "";
  	    rhyzLAL[3][2] = "";
  	    
  	    String[][] moriLAL = new String[3][2];
  	    moriLAL[1][1] = "";
  	    moriLAL[1][2] = "";
  	    moriLAL[2][1] = "";
  	    moriLAL[2][2] = "";
  	    ...
  	    String[][] telisLAL = new String[3][2];
  	    telisLAL[1][1] = "Punch";
  	    telisLAL[1][2] = "";
  	    telisLAL[2][1] = "";
  	    telisLAL[2][2] = "";
  	    ...
  	    String[][] abutensLAL = new String[3][2];
  	    abutensLAL[1][1] = "Punch + Kick";
  	    abutensLAL[1][2] = "";
  	    abutensLAL[2][1] = "";
  	    abutensLAL[2][2] = "";
  	    abutensLAL[3][1] = "";
  	    ...
  	    String[][] GoliathLAL = new String[3][2];
  	    GoliathLAL[1][1] = "";
  	    GoliathLAL[1][2] = "";
  	    GoliathLAL[2][1] = "";
  	    GoliathLAL[2][2] = "";
  		...
  		Character Rhyz = new Character("Rhyz", 1, 10, 8, 15, 7, 19, 12, 8, 10, 20, rhyzLAL, 10);
  		Character Mori = new Character("Mori", 1, 6, 8, 12, 18, 14, 12, 8, 10, 20, moriLAL, 8);
  		Character Telis = new Character("Telis", 3, 18, 15, 8, 4, 19, 12, 8, 10, 30, telisLAL, 14);
  		Character Abutens = new Character("Abutens", 3, 15, 15, 18, 15, 17, 17, 18, 18, 30, abutensLAL, 15);
  		Character Goliath = new Character("Goliath", 3, 20, 13, 15, 15, 8, 8, 15, 15, 60, GoliathLAL, 17);
  		Character ORB = new Character("RED ORB", 3, 18, 18, 18, 18, 18, 18, 18, 18, 100, ORBLAL, 16);
  ...
  if (isu.equalsIgnoreCase("1")) {
	  ...
	  System.out.println("\"Just check it out. I think their- her? name is Rhyz. Good luck, mate.\"");
		  ...
		  System.out.println("\"I think her name is Rhyz. Looks fem, coily hair, polished chrome arms. Possibly connected to Magelan if the bounty on her is any indication. Thats about all I know, but I'll let you know if anything else comes up.\"");
	  }
  }
  ...
  while (alive) {
	  if (coyn <= 40 || imBlockers <= 0) {
		  System.out.println(acerin + " is lucky. " + he + " passes away in the night. Unable to purchase immunoblockers on " + his + " way home, " + he + " experiences a pleasant dream created from the excruciating experience of a lethal immune response. " + he + " doesn't even feel a bit of discomfort as organs shut down one by one for want of coin. Its fortunate " + he + " made it this far, given the circumstances.");
		  ...
		  wakeup.WakeUp(imBlockers, aHPmax,aBuff,aQuick,aTech,aHacking,aBookS,aStreetS,aDealing,aCool, coyn);
		 ...
		 // System.out.print(contacts);
		  ...
		  if (travelChoice.equalsIgnoreCase("Pier")) {
			  Pier pier = new Pier(aBuff, aQuick, aTech, aHacking, aBookS, aStreetS, aDealing, aCool, aSneak, aDodge, aEyes, aCharm, aIntimidate, aLie, aHPmax);
			  ...
			  Clinic clinic = new Clinic(aBuff, aQuick, aTech, aHacking, aBookS, aStreetS, aDealing, aCool, aSneak, aDodge, aEyes, aCharm, aIntimidate, aLie, aHPmax, background);
		  } else if (travelChoice.equalsIgnoreCase("Angel City") ||travelChoice.equalsIgnoreCase("Capitol District")){
